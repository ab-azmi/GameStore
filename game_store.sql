...
(1, 1, 9, 'GG bang grafiknya'),
(2, 1, 9, 'mantap bang lanjutkan'),
(3, 2, 8, 'Menegangkan bang'),
(4, 3, 8, 'Horror banget bang'),
(5, 4, 9, 'Menyejukkan Hati dan Jiwa'),
(7, 5, 10, 'Nostalgia bang'),
(8, 6, 7, 'susah bang, ga paham');
...
INSERT INTO `friends` (`id_user_1`, `id_user_2`, `berteman`) VALUES
(1, 2, 1),
(1, 3, 1);
...
INSERT INTO `game_requirement` (`id_game`, `CPU`, `RAM`, `OS`, `video_card`) VALUES
(1, 'Ryzen 3 1200 - 3.1 Ghz / Core i5-4460 - 3.2 Ghz', ' 8 GB', 'Windows 10 (64-bit versions only)', 'AMD Radeon R9 380 or NVIDIA GeForce GTX 960 or better'),
(2, 'AMD Ryzen 3 1200 @ 3. Ghz or Intel Core i5-4460 @ 3.1 Ghz', '8 GB (Dual-channel mode)', 'Windows 10', 'AMD RX 460 (4 GB) or NVIDIA GeForce GTX 960 (4 GB)'),
(3, 'Intel i5-4460 AMD Ryzen 3 1200 Or equivalent', '8 GB', 'Windows 10', 'NVIDIA GTX 970 (4 GB) AMD Radeon RX 470 (4 GB) Or equivalent'),
(4, ' Intel Core i5-2500K (4 * 3300) AMD Phenom II X4 965 (4 * 3400) or equivalent', '8 GB RAM', 'Windows 7, 8.1, 10 x64', 'GeForce GTX 1050 (2048 MB) / Radeon RX 550 (4096 MB)'),
(5, ' AMD FX-6100 / Intel Core i3-3220 or Equivalent', '12 GB', '64-bit Windows 7/8.1/10', 'AMD Radeon R7 360 2GB/NVIDIA GeForce GTX 650 Ti 2GB or Equivalent'),
(7, 'Intel Core i5-6600K / AMD FX-6300 or better', '8 GB', 'Windows 10', '2 GB Nvidia GeForce GTX 760 or AMD Radeon R9 280'),
(8, 'Intel Core i5-6600 or AMD Ryzen 5 2600', '12 GB RAM', 'Windows 10 64bit', 'Nvidia GeForce GTX 960, 4 GB or AMD Radeon R9 380, 4 GB');
...
(9, 'admin', '$2y$10$AFaauy5PcUmZAy8/92c62OyF7bqBP36c3PImh/j.JIEdi/eh4ER3W', '');
...
--
-- Indexes for table `game_requirement`
--
...
--
-- Constraints for table `game_requirement`
--
ALTER TABLE `game_requirement`
  ADD CONSTRAINT `game_requirement_ibfk_1` FOREIGN KEY (`id_game`) REFERENCES `games` (`id_game`);
